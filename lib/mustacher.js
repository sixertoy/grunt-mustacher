            ...
            if (!_files.length) {
                ...
                _files.forEach(function (task, index, config) {
                    ...
                    if (!task.src.length) {
                        ...
                        /*
                        if( _options.outputExtension )
                        {
                            var outputFile = Path.basename( task.dest ).split( '.' );
                            outputFile = ( outputFile[ 0 ]+_options.outputExtension );
                            outputFile = Path.dirname( task.dest )+Path.sep+outputFile;
                        }
                        */
